...
const MAN_MASTER_HOST = shortDomain ? `http://v3.man.server.${area}.sky1088.com`: `http://v3-man-master-${area}`;
const MAN_REDIS_HOST = shortDomain ? `http://v3.manager-redis.server.${area}.sky1088.com` : `http://v3-man-redis-${area}`;
const MAN_MSSQL_HOST = shortDomain ? `http://v3.manager-mssql.server.${area}.sky1088.com` : `http://v3-man-mssql-${area}`;
const MAN_MYSQL_HOST = shortDomain ? `http://v3.manager-mysql.server.${area}.sky1088.com` : `http://v3-man-mysql-${area}`;
const RES_REDIS_HOST = shortDomain ? `http://v3.res-redis.server.${area}.sky1088.com` : `http://v3-res-redis-${area}`;
const RES_MASTER_HOST = shortDomain ? `http://v3.res.server.${area}.sky1088.com` : `http://v3-res-master-${area}`;
const RES_OTS_HOST = shortDomain ? `http://v3.res-ots.server.${area}.sky1088.com` : `http://v3-res-ots-${area}`;
